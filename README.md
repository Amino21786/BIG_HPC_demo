...
3) Open folder with the directory:
```
/campaign/EB-MA3194M-019/BIG_HPC_demo
```
# Activate the venv
...
```
- Image denoising for Shepp-Logan Phantom script:
```
python run_experiment.py configure --parameters alg_parameters.json --experiment alg_experiments.json --script denoising_gd.sh
```
